...
export interface IZoweUSSTreeNode extends IZoweTreeNode {
     ...
     */
    rename?(newNamePath: string): void;
    /**
     ...
     */
    openUSS?(download: boolean, previewFile: boolean, ussFileProvider: IZoweTree<IZoweUSSTreeNode>): void;
    /**
     ...
     * @param filePath
     */
    deleteUSSNode?(ussFileProvider: IZoweTree<IZoweUSSTreeNode>, filePath: string): void;
    /**
     ...
     */
    renameUSSNode?(ussFileProvider: IZoweTree<IZoweUSSTreeNode>, filePath: string): void;
    /**
     * Refreshes node and reopens it.
     * @param hasClosedInstance
     */
    refreshAndReopen?(hasClosedInstance?: boolean): void;
    /**
     * Adds a search node to the USS favorites list
     *
     * @param {USSTree} ussFileProvider
     */
    saveSearch?(ussFileProvider: IZoweTree<IZoweUSSTreeNode>): void;
}
