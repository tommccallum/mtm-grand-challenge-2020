...
export enum PersistenceSchemaEnum {
    Dataset = "Zowe-DS-Persistent", // eslint-disable-line @typescript-eslint/naming-convention
    USS = "Zowe-USS-Persistent",    // eslint-disable-line @typescript-eslint/naming-convention
    Job = "Zowe-Jobs-Persistent"    // eslint-disable-line @typescript-eslint/naming-convention
}
